...
namespace DotNetOpenAuth.AspNet.Clients
{
    ...
    public class FedeFacebookClient : OAuth2Client
    {
        ...
        public FedeFacebookClient(string appId, string appSecret)
        ...
        public FedeFacebookClient(string appId, string appSecret, params string[] requestedScopes)
            : base("facebook")
        {
